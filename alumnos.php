                      ...
                      <div class="span6">
                        ...
                        <div class="btn-group">
                            <button class="btn" data-toggle="dropdown">
                            	<i class="icon-search"></i> <strong>Consultar por Categoria</strong> <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu">
                              <?php
									$c=mysql_query("SELECT * FROM proveedor WHERE estado='s'");
									while($d=mysql_fetch_array($c)){
										echo '<li><a href="alumnos.php?modelo='.$d['id'].'">'.$d['nombre'].'</a></li>';	
									}
							?>
                            <li><a href="alumnos.php?modelo=0">Todos</a></li>
                            </ul>
                        </div>
                        <br><br>
                        <form name="form1" method="post" action="">
                            <div class="input-prepend">
                                ...
                                <input name="bus" type="text" placeholder="Buscar Producto por nombre" class="input-xlarge" autocomplete="off" class="typeahead">
                            </div>
                        </form>
                        </div>
                      </div>
      ...
      <tr>
        <td>
				...
				if(!empty($_POST['nombre'])){
					...
					if(empty($_POST['id'])){
						...
						echo '	<div class="alert alert-info" align="center">
									...
									<strong>
										El Producto "'.$nombre.'" Registrado con Exito							
									</strong>
								</div>';
						...
						echo '	<div class="alert alert-info" align="center">
									<button type="button" class="close" data-dismiss="alert">×</button>
									<strong>
										El Producto "'.$nombre.'" Actualizado con Exito							
									</strong>
								</div>';
					}
        	...
        	<table class="table table-bordered table table-hover">
			  ...
			  ?>
                  <tr>
                    <td><i class="icon-tag"></i> <?php echo trim($dato['nombre']); ?></td>
                    ...
                    <td>
                        ...
                        <a href="alumnos.php?del=<?php echo $dato['id']; ?>" class="btn btn-mini" title="Eliminar de la Lista">
...
<ul class="nav nav-tabs">
  <li role="presentation" class="active"><a href="alumnos.php">Anuncios</a></li>
