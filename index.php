  ...
  <body>
    ...
    <div class="container">
      <form name="form1" method="post" action="" class="form-signin">
              ...
              <div id="apDiv1">
                <!--<li id="fat-menu" class="dropdown"> <a href="#" id="drop3" role="button" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user"></i>Acceder a</a>
                  <ul class="dropdown-menu" role="menu" aria-labelledby="drop3">
                    <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php" target="admin"><i class="icon-flag"></i> Panel usuarios</a></li>
                    
                  </ul>
                </li>-->
              </div>
              <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
              <a class="brand" href="index.php">HR Administrador</a>
        ...
        <p>Acceso a Panel Administrador.</p>
